...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/postgres"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="postgres"
INSTDIR="$HOME/.local/share/dockermgr/postgres"
APPDIR="$HOME/.local/share/srv/docker/postgres"
DATADIR="$HOME/.local/share/srv/docker/postgres/files"
...
HUB_URL="casjaysdevdocker/postgres:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if [ -z "$HUB_URL" ] || [ "$HUB_URL" = "hello-world" ] || echo "$HUB_URL" | grep -q "postgres"; then
